 ...
 */
contract FRAN_Token is StandardToken, Ownable {
  ...
  string public constant name     = "FRAN";
  string public constant symbol   = "FN";
...
contract Sale is CommonCrowdsale {
